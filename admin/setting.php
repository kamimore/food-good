...
if(isset($_POST['submit'])){
	$cart_min_price=safe($_POST['cart_min_price']);
	$cart_min_price_msg=safe($_POST['cart_min_price_msg']);
	$website_close=safe($_POST['website_close']);
	$website_close_msg=safe($_POST['website_close_msg']);
	$wallet_amt=safe($_POST['wallet_amt']);
	$referral_amt=safe($_POST['referral_amt']);

	mysqli_query($conn,"update setting set cart_min_price='$cart_min_price',
	cart_min_price_msg='$cart_min_price_msg', website_close='$website_close',
	website_close_msg='$website_close_msg',wallet_amt='$wallet_amt',
...
<div class="row">
              ...
              <div class="card">
                <div class="card-body">
                  <form class="forms-sample" method="post">
                    ...
                    <div class="form-group">
                      <label for="exampleInputEmail3" required>Minimum Price Message</label>
			...
			<label for="exampleInputEmail3" required>Referral Amt</label>
						<input type="textbox" class="form-control"
						 placeholder="Website close msg" name="referral_amt"
						 value="<?php echo $referral_amt?>">
						</div>
