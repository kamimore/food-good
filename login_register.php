...
if(isset($_GET['referral_code']) && $_GET['referral_code']!=''){
	$_SESSION['FROM_REFERRAL_CODE']=safe($_GET['referral_code']);
}
?>
                                            ...
                                            <form  method="post" id="frmLogin">
                                                ...
                                                <div class="button-box">
                                                    <div class="login-toggle-btn">
                                                        <a href="<?php echo user_login?>forgot_password">Forgot Password?</a>
                                                    </div>
                                                    <button type="submit" id="login_submit">Login</button>
                                                  <input type="hidden" name="type" value="login"/>
                                                  <input type="hidden" name="is_checkout" value="" id="is_checkout"/>

                                                  <div id="form_login_msg" class="success_field"></div>                           </div>
                                            </form>
                                        </div>
                                    </div>
                                </div>
