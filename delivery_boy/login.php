...
if(isset($_SESSION['DELIVERY_BOY_USER_LOGIN']) and $_SESSION['DELIVERY_BOY_USER_LOGIN']!='')
{
 redirect('index');
}
if(isset($_POST['submit'])){
	...
	echo $sql="select * from delivery_boy where mobile='$mobile' and password='$password'";
	...
	if($row['status']==1)
  {
    $_SESSION['DELIVERY_BOY_USER_LOGIN']='yes';
		...
		$msg="You are inactive , contact to admin";
            ...
            <div class="auth-form-light text-left p-5">
              ...
              <form class="pt-3" method="post">
                <div class="form-group">
                  <input type="number" class="form-control form-control-lg" id="exampleInputEmail1" placeholder="Mobile" name="mobile" required>
                </div>
                <div class="form-group">
