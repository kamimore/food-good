...
if(isset($_GET['set_order_id'])){
	$set_order_id=safe($_GET['set_order_id']);
	$delivered_on=date('Y-m-d h:i:s');
	mysqli_query($conn,"update order_master set order_status=4,delivered_on='$delivered_on' where id='$set_order_id' and
	 delivery_boy_id='".$_SESSION['DELIVERY_BOY_ID']."'");

}

$sql="select order_master.*,order_status.order_status as order_status_str 
from order_master,order_status where order_master.order_status=order_status.id 
and order_master.delivery_boy_id='".$_SESSION['DELIVERY_BOY_ID']."' and order_master.order_status!=4 order by order_master.id desc";
         ...
         <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
            <div class="navbar-menu-wrapper d-flex align-items-stretch justify-content-between">
               <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
                  <a class="navbar-brand brand-logo" href="index"><img src="../admin/assets/images/logo.png" alt="logo"/></a>
