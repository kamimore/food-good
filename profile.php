...
<h6>Referral Link:<span style="color:blue;text-decoration:underline;" class="copy_text">
	<?php echo user_login?>login_register?referral_code=
	<?php echo $getUserDetails['referral_code']?></span>&nbsp
	<span class="copy_button" onclick="copyfunction()" >Copy</span></h6>
